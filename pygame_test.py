...
player_score = 1 #Start of the game the player will have 0 ponits
...
def collected_coins():
    global player_score
    collected_coins= pygame.sprite.spritecollide(player_init, pygame.sprite.Group, True)       
